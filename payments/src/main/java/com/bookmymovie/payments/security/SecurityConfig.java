...
public class SecurityConfig {
    ...
    public SecurityFilterChain getSecurity(HttpSecurity security) throws Exception {
        return security.authorizeHttpRequests(requestMatcher -> {
                    requestMatcher.requestMatchers("/**").permitAll();
//                    requestMatcher.requestMatchers("/events/admin/**").hasAnyRole("EVENT_ORGANISER", "ADMIN")
//                            .requestMatchers("/venue/admin/**").hasAnyRole("ADMIN", "VENUE_OWNER")
